...
function Page({ params }: { params: { id: string } }) {
  ...
  // Example tasks data for demonstration
  useEffect(() => {
      ...
      >
        <motion.div className="col-span-2" variants={cardVariants}>
          <div className="flex flex-col gap-5">
            ...
            <Card className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-lg border border-slate-200 dark:border-slate-700 shadow-lg h-[500px]">
              <CardHeader>
